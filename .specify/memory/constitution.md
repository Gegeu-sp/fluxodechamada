...
- `js/firebase-config.js` (configuração real do Firebase) fica no `.gitignore`; apenas `js/firebase-config.example.js` é versionado.
...
**Version**: 2.1.0 | **Ratified**: 2026-08-11 | **Last Amended**: 2026-08-12
